...
public class Hello {
    ...
    public String getHelloWorld2(){
        String ret = "Hello World Post: " + helloService.quantidadePost();
        return ret;
    }

    @PutMapping("/hello")
    public String getHelloWorld3(){
        String ret = "Hello World Put: " + helloService.quantidadePut();
        return ret;
    }

    @DeleteMapping("/hello")
    public String getHelloWorld4(){
        String ret = "Hello World Delete: " + helloService.quantidadeDelete();
        return ret;
    }
}
